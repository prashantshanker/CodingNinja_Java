...
public class BSTRepalceWithSumOfGreaterNodes {
	...
	{
		 Sum S = new Sum(); 
	     replaceWithLargerNodesSumUse(root, S);
	}
	public static void replaceWithLargerNodesSumUse(BinaryTreeNode<Integer> root, Sum S) 
	    { 
	        if (root == null) { 
	            return; 
	        }
	        replaceWithLargerNodesSumUse(root.right, S);  
	        S.sum = S.sum + root.data; 
	        root.data = S.sum; 
	        replaceWithLargerNodesSumUse(root.left, S);  
	    } 
